...
class AdminAnorganik extends StatefulWidget {
  const AdminAnorganik({super.key});

  @override
  _AdminAnorganikState createState() => _AdminAnorganikState();
}

class _AdminAnorganikState extends State<AdminAnorganik> {
